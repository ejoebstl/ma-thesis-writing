...
\begin{align*}
\frac{\partial\mathcal{L}_{\text{MMI}}}{\partial p^*_{s_{j,t}}} &= p(x_t = s_{j,t}|O) - \frac{1}{p^*_{s_{j,t}}}
\end{align*}
...
\begin{align}
\label{eq:mmi_grad}
\frac{\partial\mathcal{L}_{\text{MMI}}}{\partial p^*_{s_{j,t}}} &= \gamma_t(j) - \frac{1}{p^*_{s_{j,t}}}
\end{align} 
...
\subsection{State Minimum Bayes Risk}
