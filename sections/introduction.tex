...
\item Chapter \ref{ch:tdnn_design} outlines design decisions we made when designing a time delay neural network acoustic model and underpins them with experimental evidence. We also briefly investigate the effects of sequence training. 
