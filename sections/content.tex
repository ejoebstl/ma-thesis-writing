...
\begin{minipage}{\linewidth}
	...
	\begin{tabular} {|l !{\vrule width 1pt} c | c | c | c !{\vrule width 1pt} c | c | c | c | c |}
		\hline
		Model & \multicolumn{4}{c !{\vrule width 1pt}}{Four Layer} & \multicolumn{5}{c|}{Five Layer} \\
		\hline
...
\begin{minipage}{\linewidth}
	...
	\end{axis}
	\end{tikzpicture}
	\captionof{figure}{TODO TODO TODO Word Error Rate for different shuffling strategy}
...
\begin{minipage}{\linewidth}
	...
	\end{axis}
	\end{tikzpicture}
	\captionof{figure}{Word Error Rate per softmax adjustment $1/\tau$ for a four-layer TDNN model $\frac{1}{\tau}$}
