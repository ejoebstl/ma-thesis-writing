...
\end{tikzpicture}
\end{minipage}
\captionof{figure}{Illustrative example of the word error rate for different $L_p$ and $L_z$ parameters for a four-layer TDNN (left) and a three-layer TDNN (right) TODO is the 3L TDNN here a good idea? }
\label{fig:lp_lz}
\end{minipage}
\\ \\
